...
" Version:      0.1
" Description:  Compile a Google Closure Template file (.soy) each time it's saved
" Last Modified: Jul 20, 2012

if !exists("soy_command")
  let soy_command = 'java'
endif

if !exists("soy_command_options")
  let soy_command_options = '-jar "C:\closure-compiler\SoyToJsSrcCompiler.jar" --outputPathFormat'
endif
...
autocmd BufWritePost,FileWritePost *.soy call SoyCompile()
...
function SoyCompile() 
  ...
  let cmd_output = system(g:soy_command . ' ' . g:soy_command_options . ' ' . current_file . '.js ' . current_file)
